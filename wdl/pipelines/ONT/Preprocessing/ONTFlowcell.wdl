...
workflow ONTFlowcell {
    ...
    call ONT.PartitionManifest as PartitionManifest { input: manifest = manifest, N = num_shards }

    scatter (manifest_chunk in PartitionManifest.manifest_chunks) {
