...
workflow HybridPhase {
    ...
    input {
        ...
        File phased_joint_vcf
        File phased_joint_vcf_tbi
        File phased_joint_sv
        File phased_joint_sv_tbi
        File reference
    ...
    call SplitMultiallelicCalls as Norm_SNPs { input:
        bcftools_merged_vcf = phased_joint_vcf,
        bcftools_merged_vcf_tbi = phased_joint_vcf_tbi,
        prefix = prefix
    }
