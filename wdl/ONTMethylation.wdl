...
task Megalodon {
    ...
    command <<<
        ...
        samtools addreplacerg -r '@RG\tID:mappings\tSM:~{SM}' megalodon_results/mappings.bam | samtools reheader mappings.header.sam - > megalodon_results/mappings.rh.bam
        ...
        samtools addreplacerg -r '@RG\tID:mod_mappings\tSM:~{SM}' megalodon_results/mod_mappings.bam | samtools reheader mod_mappings.header.sam - > megalodon_results/mod_mappings.rh.bam
        ...
        samtools addreplacerg -r '@RG\tID:variant_mappings\tSM:~{SM}' megalodon_results/variant_mappings.bam | samtools reheader variant_mappings.header.sam - > megalodon_results/variant_mappings.rh.bam
