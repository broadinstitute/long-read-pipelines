...
task Pepper {
    ...
    runtime {
        ...
        memory:                 "96 GiB" # select_first([runtime_attr.mem_gb,            default_attr.mem_gb]) + " GiB"
        disks: "local-disk 500 HDD" # +  select_first([runtime_attr.disk_gb,           default_attr.disk_gb]) + " HDD"
        zones: zones
