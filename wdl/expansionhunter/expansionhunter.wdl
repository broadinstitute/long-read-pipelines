...
workflow ExpansionHunterWorkflow {
    Int num_shards
    File ref_fasta
    File ref_fasta_fai
    File ref_fasta_dict
    ...
    String expansion_hunter_image="weisburd/expansionhunter@sha256:a8fcbccf9dda65fa00d3707ad3b722b6fd734f17af7e81408b08b97b2b9d83eb"
    ...
    call GatherVCFs {
        input:
            ref_fasta=ref_fasta,
            ref_fasta_fai=ref_fasta_fai,
            input_vcfs=ExpansionHunter.output_vcf_gz,
            input_vcfs_tbi=ExpansionHunter.output_vcf_gz_tbi,
            output_prefix=output_prefix,
            docker_image=expansion_hunter_image
    }
}
...
task ExpansionHunter {
    ...
    command {
        ...
        python3 /generate_repeat_specs.py --expansion-hunter ${ref_fasta} ${repeat_regions_bed} repeat_specs_dir
