    ...
    call FF.FinalizeToDir as t_64_FinalizeCCSLongbowStats {
        input:
            files = [
                ...
                t_53_CCS_longbow_stats.array_element_length_counts_plot_png,
                t_53_CCS_longbow_stats.array_element_length_counts_plot_png,
    ...
    call FF.FinalizeToDir as t_65_FinalizeReclaimableLongbowStats {
        input:
            files = [
                ...
                t_54_Reclaimable_longbow_stats.array_element_length_counts_plot_png,
                t_54_Reclaimable_longbow_stats.array_element_length_counts_plot_png,
    ...
    call FF.FinalizeToDir as t_66_FinalizeReclaimedLongbowStats {
        input:
            files = [
                ...
                t_55_Reclaimed_longbow_stats.array_element_length_counts_plot_png,
                t_55_Reclaimed_longbow_stats.array_element_length_counts_plot_png,
    ...
    call FF.FinalizeToDir as t_67_FinalizeOverallLongbowStats {
        input:
            files = [
                ...
                t_57_Overall_longbow_stats.array_element_length_counts_plot_png,
                t_57_Overall_longbow_stats.array_element_length_counts_plot_png,
    ...
    call FF.FinalizeToDir as t_68_FinalizeAllPassedLongbowStats {
        input:
            files = [
                ...
                t_56_Passed_longbow_stats.array_element_length_counts_plot_png,
                t_56_Passed_longbow_stats.array_element_length_counts_plot_png,
