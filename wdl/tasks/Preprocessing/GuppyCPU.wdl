...
##########################################################################################
# A workflow that runs the Guppy basecaller on ONT FAST5/POD5 files.
...
# - All fast5/pod5 files within the given GCS dir, gcs_input_dir, will be processed
...
task ListInputs {
    ...
    command <<<
        gsutil ls "~{indir}/**.*5" > input_files.txt
    >>>
