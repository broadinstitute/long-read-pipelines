...
workflow CallVariantsWithHaplotypeCaller_Simplified {
    meta {
        author: "Jonn Smith"
    ...
    call ReblockGVCF as ReblockHcGVCF {
        input:
            gvcf = CallVariantsWithHC.output_vcf,
            gvcf_index = CallVariantsWithHC.output_vcf_index,
            ref_fasta = ref_fasta,
    ...
    output {
        ...
        File bamout = CallVariantsWithHC.bamout
        File bamout_index = CallVariantsWithHC.bamout_index
    }
}
...
task HaplotypeCaller_GATK4_VCF {
    ...
    output {
        ...
        File bamout_index = "~{prefix}.bamout.bai"
    }
