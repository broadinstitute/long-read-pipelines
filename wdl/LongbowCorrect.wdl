...
workflow LongbowCorrect {
    ...
    call Utils.ShardReads as t_003_ShardReads {
        input:
            bam = reads_bam,
            bam_index = reads_bam + ".bai",
            prefix = sample_name + "_shard",
            num_shards = 100,
    }

    scatter (main_shard_index in range(length(t_003_ShardReads.shards))) {
        File sharded_reads = t_003_ShardReads.shards[main_shard_index]
...
#    }
#
#    call LONGBOW.Correct as t_003_CorrectReads {
#        input:
#            reads = reads_bam,
#            barcode_allow_list = cell_barcode_whitelist,
#            model = mas_seq_model,
...
#    }
#
#    call Utils.IndexBam as t_004_IndexCorrectedReads {
#        input:
#            bam = t_003_CorrectReads.corrected_barcodes_bam
#    }
#
#    call Utils.IndexBam as t_005_IndexUnCorrectedReads {
#        input:
#            bam = t_003_CorrectReads.uncorrected_barcodes_bam
#    }
#
#    call PB.PBIndex as t_006_PbIndexCorrectedReads {
#        input:
#            bam = t_003_CorrectReads.corrected_barcodes_bam
#    }
#
#    call PB.PBIndex as t_007_PbIndexUncorrectedReads {
#        input:
#            bam = t_003_CorrectReads.uncorrected_barcodes_bam
#    }
#
...
#
#    # Finalize the final corrected, aligned array elements:
#    call FF.FinalizeToDir as t_008_FinalizeQuantifiedArrayElements {
#        input:
#            files = [
#                t_003_CorrectReads.corrected_barcodes_bam,
#                t_004_IndexCorrectedReads.bai,
#                t_006_PbIndexCorrectedReads.pbindex,
#
#                t_003_CorrectReads.uncorrected_barcodes_bam,
#                t_005_IndexUnCorrectedReads.bai,
#                t_007_PbIndexUncorrectedReads.pbindex,
#            ],
#            outdir = base_out_dir
#    }
#
