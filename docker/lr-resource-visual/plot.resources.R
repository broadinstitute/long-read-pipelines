...
if (3!=length(options)) {
    stop("I need input.log output.pdf title_string")
}
input_log = options[1]
output_pdf = options[2]
plot_title = options[3]


ts_df = get_time_series_df(input_log)

plot_time_series_df(ts_df, output_pdf, plot_title)
